...
import pandas as pd
from ydata_profiling import ProfileReport #生成报表
from streamlit_pandas_profiling import st_profile_report #显示报表
import os
import pycaret.classification as pc_cl #auto_ml_classfy
import pycaret.regression as pc_rg #auto_ml_regression
import mlflow #model management
